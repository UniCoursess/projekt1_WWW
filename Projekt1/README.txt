...
CSS:
Plik Css. Stosuję zmienne w celu zwiększenia czytelności kodu, ta część zapewnia również układ grid, oraz responsywność i prostą animację.
i wyświetlanie tekstu po najechanu kursorem na jedno ze zdjęć.
Pewna część kodu nie jest wykorzystywana, ale zdecydowałem się ją zostawić, gdybym kiedyś chciał zmienić wygląda strony.

JS:
Plik script.js opowiada za obsługę quizu: w tym celu posługuję sie id potrzebnych elementów, pytania są pobierane z pliku json przy
